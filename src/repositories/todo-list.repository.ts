...
> {
  ...
  constructor(
    @inject('datasources.postgres_appbitos') dataSource: PostgresAppbitosDatasource, @repository.getter('TodoRepository') protected todoRepositoryGetter: Getter<TodoRepository>,
  ) {
